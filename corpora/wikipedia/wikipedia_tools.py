...
if __name__ == "__main__":
    ...
    parser.add_argument('subcommand', choices=SUBCOMMANDS.keys(), help='Which Wikipedia operation to perform')
    parser.add_argument('-q', '--quiet', action='store_true', help='Disables progress indicators on stdout')
    parser.add_argument('-i', '--input', default='data', help='Specifies the directory to crawl for input Wikipedia corpus data')
